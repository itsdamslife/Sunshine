...
public class TestProvider extends AndroidTestCase {
    ...
    public void testInsertReadProvider() {
        ...
        ContentValues testValues = com.example.android.sunshine.app.test.TestDb.createNorthPoleLocationValues();
        ...
        com.example.android.sunshine.app.test.TestDb.validateCursor(cursor, testValues);
        ...
        ContentValues weatherValues = com.example.android.sunshine.app.test.TestDb.createWeatherValues(locationRowId);
        ...
        com.example.android.sunshine.app.test.TestDb.validateCursor(weatherCursor, weatherValues);
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocation(com.example.android.sunshine.app.test.TestDb.TEST_LOCATION),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithStartDate(
                        com.example.android.sunshine.app.test.TestDb.TEST_LOCATION, com.example.android.sunshine.app.test.TestDb.TEST_DATE),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithDate(com.example.android.sunshine.app.test.TestDb.TEST_LOCATION, com.example.android.sunshine.app.test.TestDb.TEST_DATE),
                null,
                null,
                null,
                null
    ...
    public void testUpdateAndReadWeather() {
        ...
        com.example.android.sunshine.app.test.TestDb.validateCursor(weatherCursor, kalamazooAltered);
    }
